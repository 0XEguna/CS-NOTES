...
__Kehlani is one of many software developers that decided to start learning machine learning.__

__Following the recommendation of her peers, the first algorithm she looked into was decision trees. She found a lot of resemblance with some of the techniques she already knew.__

__After a few weeks, Kehlani wants to summarize what she learned in an email to her team, but first, she wants you to review it.__

__These are the advantages that Kehlani listed. Which of them would you say are actual advantages of decision trees?__
...
Check ["To Boost or not to Boost: On the Limits of Boosted Neural Networks"](https://arxiv.org/pdf/2107.13600), the paper cited above comparing the overfitting tendency of a single Decision Tree versus an ensemble of trees.
